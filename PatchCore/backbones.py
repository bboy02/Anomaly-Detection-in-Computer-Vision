...
_BACKBONES = {
    ...
    "vit_base_16_384": 'timm.create_model("vit_base_patch16_384", pretrained=True)',
    ...
    "maxvit_tiny_tf_512": 'timm.create_model("maxvit_tiny_tf_512", pretrained=True)',
    "levit_conv_512":'timm.create_model("levit_conv_512",pretrained=True)',
